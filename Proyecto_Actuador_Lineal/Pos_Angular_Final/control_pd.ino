//this code is for controlling the position with a motor with an encoder, all of this with PID
//Motor
#define EN 11
#define ina 9
#define inb 10
...
const float Di = 0.02;//step of time
//control variables
int e=0;//error
...
void loop() {
  ...
  dedt = (e-eprev)/Di;//derivative error
  PWM_ctrl = kp*e + kd*dedt;
  //Serial.print("PWM= ");
